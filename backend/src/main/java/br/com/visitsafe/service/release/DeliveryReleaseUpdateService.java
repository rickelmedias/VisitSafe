...
public class DeliveryReleaseUpdateService {

    private final DeliveryReleaseRepository releaseRepo;
    private final UnitRepository unitRepo;

    @Transient
    public DeliveryRelease update(UUID id, DeliveryReleaseUpdateRequestDTO dto) {
        DeliveryRelease release = releaseRepo.findById(id)
